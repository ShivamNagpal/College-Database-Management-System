...
public class PreviewSemesterSection extends UiScene {
    ...
    private Task<List<SemesterSectionData>> mSemesterSectionDataTask;
    private ComboBox<String> mSearchModeComboBox;
    private TextField mSearchTextField;
    private Task<List<SemesterSectionData>> mSearchDataTask;
    ...
    protected Pane getLayout() {
        ...
        mSemesterSectionDataTask = getSemesterSectionDataTask();

        Thread SemesterSectionThread = new Thread(mSemesterSectionDataTask);
    ...
    private Task<List<SemesterSectionData>> getSemesterSectionDataTask() {
        return new Task<List<SemesterSectionData>>() {
            @Override
    ...
    private void searchAction() {
        if (mSemesterSectionDataTask != null) {
            mSemesterSectionDataTask.cancel(true);
        }
        ...
        if (key == null || key.isEmpty()) {
            mSemesterSectionDataTask = getSemesterSectionDataTask();
            Thread thread = new Thread(mSemesterSectionDataTask);
            thread.start();
        } else {
            String mode = mSearchModeComboBox.getSelectionModel().getSelectedItem();
            mSearchDataTask = new Task<List<SemesterSectionData>>() {
                @Override
                protected List<SemesterSectionData> call() {
                    return DatabaseHelper.searchSemesterSectionDetails(key, mode);
                }
